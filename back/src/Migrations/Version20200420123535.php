 ...
 */
final class Version20200420123535 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, categorie_id INT DEFAULT NULL, birthday DATE DEFAULT NULL, firstname VARCHAR(60) NOT NULL, lastname VARCHAR(90) NOT NULL, picture VARCHAR(255) DEFAULT NULL, address VARCHAR(255) NOT NULL, telephone VARCHAR(10) NOT NULL, license VARCHAR(35) DEFAULT NULL, status TINYINT(1) DEFAULT \'1\' NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649BCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
